...
Connection con= null;
    ...
    private void initComponents() {
        ...
        showbut = new javax.swing.JToggleButton();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payment ID", "Amount", "Payed By", "Payment Time"
            }
        ) {
        ...
        jScrollPane1.setBounds(20, 100, 810, 360);

        showbut.setFont(new java.awt.Font("Bahnschrift", 1, 14)); // NOI18N
        showbut.setForeground(new java.awt.Color(0, 152, 153));
        showbut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Show.png"))); // NOI18N
        ...
        showbut.setBounds(350, 60, 120, 30);
        ...
        jSeparator1.setBounds(10, 40, 840, 10);
        ...
        logout_but.setBounds(800, 0, 50, 40);

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Background.jpg"))); // NOI18N
        getContentPane().add(Background);
        Background.setBounds(0, 0, 1366, 768);

        setSize(new java.awt.Dimension(872, 509));
    ...
    private void showbutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showbutActionPerformed
        ...
        try {  
            insert = con.prepareStatement("select PaymentID,Amount,Payed_By,Payment_Time from payments where Payed_To='"+id+"'");
    ...
    private javax.swing.JToggleButton showbut;
