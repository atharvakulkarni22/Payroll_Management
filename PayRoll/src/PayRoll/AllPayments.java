...
public class AllPayments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payment ID", "Payed To", "Amount", "Payed By", "Payment Time"
            }
        ) {
        ...
        jScrollPane1.setBounds(10, 100, 799, 357);
        ...
        back_but.setBounds(710, 0, 50, 40);

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Background.jpg"))); // NOI18N
        getContentPane().add(Background);
        Background.setBounds(-6, -8, 1366, 780);

        setSize(new java.awt.Dimension(834, 502));
    ...
    private void table_update(){
        ...
        try {  
            insert = con.prepareStatement("select *from payments");
            ...
            while(rs.next()){
                ...
                for(int a=1;a<c;a++){
                    ...
                    v2.add(rs.getString("Payed_To"));
                    v2.add(rs.getString("Amount"));
                    v2.add(rs.getString("Payed_By"));
                    v2.add(rs.getString("Payment_Time"));
                }
                Df.addRow(v2);
            }
        }
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try {  
            insert = con.prepareStatement("select *from payments where Payed_To='"+id+"'");
            ResultSet rs = insert.executeQuery();
            ResultSetMetaData rsm = rs.getMetaData();   
            c = rsm.getColumnCount();
            DefaultTableModel Df;
            ...
            while(rs.next()){
                ...
                for(int a=1;a<c;a++){
                    v3.add(rs.getString("PaymentID"));
                    v3.add(rs.getString("Payed_To"));
                    v3.add(rs.getString("Amount"));
                    v3.add(rs.getString("Payed_By"));
                    v3.add(rs.getString("Payment_Time"));
                }
                Df.addRow(v3);
            }
        }
